#line 1 "C:/Users/jesus/Desktop/PracticasDispositivosProgramables/practica9/practica9.c"
...
void customChar(char pos_row, char pos_char, char* character, char location) {
 char i;
 if(location < 8) {
 Lcd_Cmd(64 + (location * 8));
 for (i = 0; i < 8; i++) Lcd_Chr_CP(character[i]);
 Lcd_Cmd(_LCD_RETURN_HOME);
 Lcd_Chr(pos_row, pos_char, location);
 }
}
